...
export default function AllProducts() {
  ...
  return (
    <div className="min-h-screen bg-white pt-20">
      ...
      {/* Hero Section */}
      <section className="relative h-80 bg-linear-to-r from-purple-900 to-blue-900 flex items-center justify-center">
        <div className="absolute inset-0 bg-black/40"></div>
        <div className="relative z-10 text-center text-white">
          <h1 className="text-6xl font-serif tracking-widest mb-4">ALL PRODUCTS</h1>
          <p className="text-xl font-light tracking-wide">Discover our complete luxury collection</p>
        </div>
      </section>
        ...
        <div className="max-w-7xl mx-auto px-6">
          <div className="flex flex-col md:flex-row gap-6 justify-between items-center">
            <div className="flex flex-wrap gap-6 items-center">
              <div>
                <label className="text-sm font-light tracking-widest mr-3">CATEGORY:</label>
                <select 
        ...
        <div className="max-w-7xl mx-auto">
          {filteredProducts.length > 0 ? (
                ...
                >
                  ...
                  >
                    ...
                    <div className="absolute top-3 left-3">
                      <span className={`px-2 py-1 text-xs tracking-widest rounded ${
            ...
            <div className="text-center py-20">
              ...
              <p className="text-gray-500 mb-8">Check back later for new arrivals</p>
              <button
                onClick={() => router.push('/')}
